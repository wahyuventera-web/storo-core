    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">Kelola pembayaran ke klien</p>
        </div>
        <Link
                ...
                disbursements.map((d, idx) => {
                  ...
                  return (
                    <tr key={d.id} className="border-b border-gray-50 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-gray-900 font-mono text-xs truncate max-w-[140px]">
                        {storeUrl ?? "-"}
                      </td>
                      <td className="py-3 px-4 text-gray-600">{d.period_label ?? "-"}</td>
                      ...
                      <td className="py-3 px-4 text-gray-500 text-xs">{formatDate(d.paid_at)}</td>
                    </tr>
                  );
                })
              ) : (
